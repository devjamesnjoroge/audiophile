...
const Hero = () => {
    return(
        ...
        <section className="hero h-[70vh] md:h-[55vh] lg:h-[85vh] relative px-6 md:px-28 bg-zinc-900">
            ...
            <div className="container absolute top-0 left-0 h-full gap-6 px-12 lg:px-28 text-white flex flex-col justify-center text-center lg:text-left items-center lg:items-start">
