...
const Hero = () => {
    return(
        <>
            <section className="hero bg-zinc-900 absolute w-full top-0 left-0 -z-10">
            ...
            <div className="container gap-6 px-12 md:px-28 text-white h-screen flex flex-col justify-center text-center md:text-left items-center md:items-start">
                ...
                <p className="text-text-grey w-3/5 md:w-2/5">Experience natural, lifelike audio and exceptional build quality made for the passionate music enthusiast.</p>
