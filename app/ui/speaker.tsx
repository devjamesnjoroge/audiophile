...
const SpeakerPromo = () => {
    return(
        ...
        <div className="h-auto lg:h-[85vh] bg-primary relative w-full rounded-lg">
            <div className="absolute lg:left-[-15%] top-0 h-[85vh] overflow-hidden" style={{zIndex: "1"}}>
            <Image src='/pattern-circles.svg' width={944} height={944} alt='pattern-circles svg' />
            </div>
            <div style={{zIndex: "2"}} className="lg:absolute left-0 top-0 flex flex-col lg:flex-row flex-wrap justify-between items-center px-8 md:px-28 lg:px-24 py-[5rem] pt-8 lg:pt-24 h-full gap-12" >
            ...
            <div className="flex-1 flex flex-col justify-center lg:justify-start items-center lg:items-start h-auto lg:h-full md:gap-8 ms-0 lg:ms-[6rem] text-center lg:text-left">
                ...
                <Link className="bg-secondary text-white hover:bg-light-grey hover:text-secondary font-bold px-8 py-3 text-sm uppercase" href='speakers/zx9'>
                see product
                </Link>
            </div>
            </div>
        ...
        <div className="pt-24">
            ...
            <Link className="bg-grey text-secondary hover:bg-secondary hover:text-white border-secondary border-2 font-bold px-8 py-3 text-sm uppercase" href='speakers/zx7'>
                see product
            </Link>
            </div>
        </div>
